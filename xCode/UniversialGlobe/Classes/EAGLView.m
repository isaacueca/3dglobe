...
-(IBAction)mapStateControlAction:(id)sender{
    ...
    switch (mapSwapState) {
        case 0:
            [self loadTexture: 1 Name: @"GlobeWithCountries_Left"];
            [self loadTexture: 2 Name: @"GlobeWithCountries_Right"];
            break;
        case 1:
            [self loadTexture: 1 Name: @"PlainGlobe_Left"];
            [self loadTexture: 2 Name: @"PlainGlobe_Right"];
        ...
        case 3:
            ...
            break;
        case 4:
            [self loadTexture: 1 Name: @"OldWorld_Left"];
            [self loadTexture: 2 Name: @"OldWorld_Right"];
            break;
        default:
            break;
    }
