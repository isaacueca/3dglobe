...
@property (retain) Texture2D* sphere;
@property (retain) Texture2D* shaft;
@property (retain) Texture2D* glow1;
@property (retain) Texture2D* glow2;
@property (retain) Texture2D* glow3;

@property (retain) Texture2D* twitter;
@property (retain) Texture2D* bubble;
